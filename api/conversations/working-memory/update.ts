...
function extractAndValidateCredentials(
  res: ServerResponse,
  body: RequestBody
...
async function callOpenAI(
  ...
  model: string,
  prompt: string
): Promise<{ success: true; workingMemory: WorkingMemory } | { success: false; error: string }> {
...
export default async function handler(req: IncomingMessage, res: ServerResponse) {
  ...
  try {
    ...
    const validated = extractAndValidateCredentials(res, body)
    ...
    json(res, 200, {
      ...
      workingMemory: {
        ...
        decisions: openaiResult.workingMemory.decisions || [],
        assumptions: openaiResult.workingMemory.assumptions || [],
        openQuestions: openaiResult.workingMemory.openQuestions || [],
        glossary: openaiResult.workingMemory.glossary || {},
        stakeholders: openaiResult.workingMemory.stakeholders || [],
