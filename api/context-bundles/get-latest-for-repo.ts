/**
 * API endpoint to get the most recent Context Bundle for a repository.
 * Returns the latest bundle across all tickets for the repo.
 */
...
export default async function handler(req: IncomingMessage, res: ServerResponse) {
  ...
  try {
    ...
    // Get the most recent bundle for this repo (across all tickets)
    ...
    console.error('Error in get latest bundle for repo handler:', err)
    return json(res, 500, {
      success: false,
