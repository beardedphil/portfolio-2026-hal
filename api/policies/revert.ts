...
export default async function handler(req: IncomingMessage, res: ServerResponse) {
  ...
  try {
    ...
    if (auditError) {
      console.error('[api/policies/revert] Failed to create audit log:', auditError)
    ...
    console.error('[api/policies/revert] Error:', err)
