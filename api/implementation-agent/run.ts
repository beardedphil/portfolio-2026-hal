...
export default async function handler(req: IncomingMessage, res: ServerResponse) {
  ...
  try {
    ...
    const promptText = [
      ...
      '   - **MUST follow the Decision Log template**: `docs/templates/decision-log.template.md`',
      '   - Must include: For each significant decision, document Context, Decision, Alternatives Considered, Trade-offs, Consequences/Follow-ups, and Links',
      '   - Must include at least one example decision entry following the template format',
      '   - If no decisions were needed, state that explicitly: "No significant implementation decisions were required for this ticket."',
      '',
