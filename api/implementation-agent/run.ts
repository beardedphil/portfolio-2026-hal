...
export default async function handler(req: IncomingMessage, res: ServerResponse) {
  ...
  try {
    ...
    const promptText = [
      ...
      '   - **MANDATORY:** This artifact is REQUIRED on every ticket. You MUST store it, even if no files changed.',
      ...
      '   - **CRITICAL:** Leaving the Changed Files artifact blank, omitting it, or using placeholder text is a PROCESS FAILURE and will cause QA to fail immediately.',
      '   - The artifact content must be non-empty and substantive. Empty artifacts or placeholders are rejected by the HAL API.',
      '',
