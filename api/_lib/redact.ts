/**
 * Redacts sensitive values from objects for diagnostics and audit logs.
...
/**
 * Redacts sensitive values (API keys, JWTs, Supabase URLs, tokens, errors containing secrets) from an object.
