...
export type ProcessReviewRecommendation = {
  text: string
...
export function ProcessReviewModal({ recommendations, onImplement, onIgnore, onClose }: ProcessReviewModalProps) {
  ...
  return (
    <div className="conversation-modal-overlay" onClick={handleOverlayClick}>
      <div 
