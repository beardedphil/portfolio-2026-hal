...
export function GithubRepoPicker({ isOpen, repos, query, onQueryChange, onSelect, onClose }: GithubRepoPickerProps) {
    ...
    <div className="conversation-modal-overlay" onClick={onClose}>
      <div className="conversation-modal" onClick={(e) => e.stopPropagation()}>
        <div className="conversation-modal-header">
          ...
          <button type="button" className="conversation-modal-close" onClick={onClose} aria-label="Close repo picker">
            ×
          </button>
        </div>
