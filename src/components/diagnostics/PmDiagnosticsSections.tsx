...
type PmDiagnosticsSectionsProps = {
...
export function PmDiagnosticsSections({
  diagnostics,
  selectedChatTarget,
  ...
  return (
    <>
      ...
      {/* PM Diagnostics: Create ticket availability */}
      ...
      {/* PM Diagnostics: Ticket creation */}
      ...
      {/* PM Diagnostics: Ticket readiness evaluation */}
