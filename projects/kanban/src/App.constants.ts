...
export const ROLLBACK_AFTER_FAILURE_MS = 
  typeof import.meta !== 'undefined' && import.meta.env?.VITE_ROLLBACK_AFTER_FAILURE_MS
    ? Number.parseInt(import.meta.env.VITE_ROLLBACK_AFTER_FAILURE_MS, 10) || 15000
    : 15000 // Default: 15 seconds - longer delay to prevent premature rollback on slow API responses
