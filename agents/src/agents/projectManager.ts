...
export async function runPmAgent(
  ...
  const createRedDocumentTool = tool({
    ...
    parameters: z.object({
      ticket_id: z.string().describe('Ticket id (e.g. "HAL-0012", "0012", or "12").'),
      red_json: z.any().describe('RED document content as a JSON object. Should contain expanded requirements, use cases, edge cases, and other detailed information.'),
      validation_status: z
