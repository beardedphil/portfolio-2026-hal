...
import { parseTicketNumber, slugFromTitle, repoHintPrefix } from './ticketIds.js'
import {
  summarizeForContext,
...
export { evaluateTicketReady, checkUnassignedTickets, PLACEHOLDER_RE }
...
// Re-export for backward compatibility
export type { ConversationTurn, WorkingMemory }
