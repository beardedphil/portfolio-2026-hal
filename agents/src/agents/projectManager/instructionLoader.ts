/**
 * Instruction loading logic for PM agent context pack.
 */
...
/** Use minimal bootstrap to avoid context overflow */
export const USE_MINIMAL_BOOTSTRAP = true

export function labelForAgentType(agentType: AgentType): string {
...
export async function loadInstructionsFromSupabase(
